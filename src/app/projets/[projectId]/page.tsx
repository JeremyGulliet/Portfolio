    ...
    return (
      <div className="mt-4 flex flex-col">
        ...
        <div className="flex flex-col items-center justify-center gap-6 p-4 xl:hidden">
          <div className="flex w-5/6 lg:w-full flex-col gap-8">
            <Link href="/projets">
            ...
            <p className="text-md whitespace-pre-line text-justify text-slate-600 dark:text-slate-300">
        ...
        {/* Ecran lg et supérieur */}
        <div className="hidden items-center justify-center gap-6 p-4 xl:flex xl:flex-row xl:gap-16 xl:mx-6 2xl:mx-0">
