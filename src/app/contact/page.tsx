  ...
  return (
    <main className="flex flex-col justify-center items-center md:flex-row lg:gap-32">
      <Spotlight
        ...
        fill="white"
      />
      <div className="flex flex-col md:w-2/5 gap-10 bg-slate-300 dark:bg-inherit rounded-xl p-8">
        <h1 className="text-2xl md:text-4xl font-bold dark:text-white text-justify">
          CONTACTEZ-MOI
        </h1>
        <p className="text-lg md:text-lg font-bold dark:text-white text-justify">
