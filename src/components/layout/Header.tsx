...
export default function Header() {
  ...
  const linkStyle = (path: string) =>
    `flex justify-center items-center text-sm xl:text-xl w-40 py-3 ${
      pathname === path
  ...
  return (
    <header className={`flex w-screen items-center justify-between py-6 font-bold dark:text-white ${karla.className}`}>
